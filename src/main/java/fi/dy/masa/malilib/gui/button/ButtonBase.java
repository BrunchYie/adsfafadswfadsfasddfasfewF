...
{
    protected static final Identifier BUTTON_TEXTURE = Identifier.splitOn("malilib:widget/button", ':');
    protected static final Identifier BUTTON_DISABLE_TEXTURE = Identifier.splitOn("malilib:widget/button_disabled", ':');
    protected static final Identifier BUTTON_HOVER_TEXTURE = Identifier.splitOn("malilib:widget/button_highlighted", ':');
