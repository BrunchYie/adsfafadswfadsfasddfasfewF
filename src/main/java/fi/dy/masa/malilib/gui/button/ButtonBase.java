...
{
    protected static final Identifier BUTTON_TEXTURE = Identifier.ofDefaultNamespace("widget/button");
    protected static final Identifier BUTTON_DISABLE_TEXTURE = Identifier.ofDefaultNamespace("widget/button_disabled");
    protected static final Identifier BUTTON_HOVER_TEXTURE = Identifier.ofDefaultNamespace("widget/button_highlighted");
