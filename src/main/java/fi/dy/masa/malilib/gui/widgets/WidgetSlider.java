...
{
    public static final Identifier BUTTON_TEXTURE = Identifier.splitOn("malilib:widget/button", ':');
    public static final Identifier BUTTON_DISABLE_TEXTURE = Identifier.splitOn("malilib:widget/button_disabled", ':');
